...
// Version de firmware
#define OPENEFI_VER_MAJOR {{OPENEFI_MAJOR}}
#define OPENEFI_VER_MINOR {{OPENEFI_MINOR}}
#define OPENEFI_VER_REV {{OPENEFI_REV}}

/*-----( Globales )-----*/

#define mtr {{MTR}}       //!< habilita encendido
...
#define DNT {{DNT}}       //!< cantidad de dientes del sensor CKP
#define Alpha {{Alpha}}   //!< modo para probar sin correcciones de tiempo, ni algoritmos de inyeccion ni sincronizacion, para encajar un 555 y probar a pelo ?)
#define ED {{ED}}         //!< cilindrada en CC del motor

/*-----( RPM )-----*/

#define RPM_per {{RPM_PER}} //periodo en ms en el que se actualizan las rpm ( si lo cambias , o arreglas el calculo para las rpm,o se rompe todo maquinola)
...
#define PMSI {{PMSI}}   //!< Cantidad de dientes entre PMS
...
// Inyeción:
#define AVCI {{AVCI}} //avance de inyeccion (si queres quemar las valvulas dejalo en 0)

// Encendido:
#define ECNT {{ECNT}} //tiempo en ms que se prende la bobina (cambie a su riesgo)
